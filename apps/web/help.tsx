...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  {number: '03', title: 'Approve folders and find repositories', description: 'Choose exactly which folders TraceMini is allowed to scan.', detail: 'Run “tracemini watch /absolute/path” on your device. Then open Settings and select “Scan repositories on my devices.” TraceMini never performs a full-device scan.', destination: 'settings', action: 'Open repository settings'},
